function newR = rezistenteSTDHigh(xR,R)
newR = 0;
switch xR
    ...
    case 2  % daca ordinul de multiplicitate este kΩ
        E24STD=[1.0 1.1 1.2 1.3 1.5 1.6 1.8 2.0 2.2 2.4 2.7 3.0 3.3 3.6 3.9 4.3 4.7 5.1 5.6 6.2 6.8 7.5 8.2 9.1 10 11 12 13 15 16 18 20 22 24 27 30 33 36 39 43 47 51 56 62 68 75 82 91 100 110 120 130 150 160 180 200 220 250 270 300 330 360 390 430 470 510 560 620 750 820 910];
...
for i=1:l
    if(R>E24STD(i))
        preindex = i;   % retinem indexul ultimei valori mai mici decat valoarea introdusa de noi in interfata grafica din standardul E24
    end
    if E24STD(i)==R
...
if flag~=1         % daca valoarea introdusa nu este una standarda E24
    ...
    elseif (preindex == 24) % daca toate val standarde sunt mai mici decat cea introdusa, val finala va fi ultima din lista E24
        ...
        newR = E24STD(preindex+1);  %altfel rotunjim valoarea in sus
    end
